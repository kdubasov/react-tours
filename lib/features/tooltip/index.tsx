  ...
  return (
    <div style={style} className={styles.wrapper}>
      <header className={styles.header}>
        <div className={styles.leftHeader}>
          <span
            ...
            data-testid="tooltip-count"
            title={`Tour step counter (${itemIdx + 1}/${countItems})`}
          >
      ...
      <footer className={styles.footer}>
        ...
        <button
          title={nextItem ? 'Next tour step' : 'Close tour'}
          disabled={isLoading}
